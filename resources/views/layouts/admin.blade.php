      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto" style="height: 650px">
          <ul class="nav flex-column">
                ...
                <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="http://127.0.0.1:8000/admin/product">
                    <svg class="bi"><use xlink:href="#cart"/></svg>
                     المنتجات
                </a>
                <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="http://127.0.0.1:8000/admin/category">
                    <svg class="bi"><use xlink:href="#cart"/></svg>
                     الاصناف
                </a>
          </ul>
